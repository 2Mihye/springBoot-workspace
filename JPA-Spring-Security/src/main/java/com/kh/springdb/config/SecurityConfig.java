...
public class SecurityConfig { // 전체 허용
	...
	@Bean
	AuthenticationManager authenticationManage(AuthenticationConfiguration a) throws Exception{ // 사용자 인증정보를 담아줌.
	...
	PasswordEncoder passwordEncoder(){
		return new BCryptPasswordEncoder(); // BCryptPasswordEncoder : BCryptPasswordEncoder 형식으로 저장
	}
}
